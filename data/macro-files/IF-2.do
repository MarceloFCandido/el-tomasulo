...
add wave -noupdate -radix unsigned /tomasulim/iq/instrIn
...
add wave -noupdate -radix unsigned -childformat {{{/tomasulim/iq/instrs[7]} -radix unsigned} {{/tomasulim/iq/instrs[6]} -radix unsigned} {{/tomasulim/iq/instrs[5]} -radix unsigned} {{/tomasulim/iq/instrs[4]} -radix unsigned} {{/tomasulim/iq/instrs[3]} -radix unsigned} {{/tomasulim/iq/instrs[2]} -radix unsigned} {{/tomasulim/iq/instrs[1]} -radix unsigned} {{/tomasulim/iq/instrs[0]} -radix unsigned}} -subitemconfig {{/tomasulim/iq/instrs[7]} {-height 15 -radix unsigned} {/tomasulim/iq/instrs[6]} {-height 15 -radix unsigned} {/tomasulim/iq/instrs[5]} {-height 15 -radix unsigned} {/tomasulim/iq/instrs[4]} {-height 15 -radix unsigned} {/tomasulim/iq/instrs[3]} {-height 15 -radix unsigned} {/tomasulim/iq/instrs[2]} {-height 15 -radix unsigned} {/tomasulim/iq/instrs[1]} {-height 15 -radix unsigned} {/tomasulim/iq/instrs[0]} {-height 15 -radix unsigned}} /tomasulim/iq/instrs
...
add wave -noupdate /tomasulim/IR/IRin
add wave -noupdate -radix unsigned /tomasulim/IR/instrIn
add wave -noupdate -radix unsigned /tomasulim/IR/instrOut
...
wave modify -driver freeze -pattern constant -value 0 -starttime 400ps -endtime 1000ps Edit:/tomasulim/adc 
wave modify -driver freeze -pattern constant -value 1 -starttime 500ps -endtime 800ps Edit:/tomasulim/rtr 
wave create -driver freeze -pattern constant -value 0 -starttime 0ps -endtime 1000ps sim:/tomasulim/IRin 
wave modify -driver freeze -pattern constant -value 1 -starttime 550ps -endtime 850ps Edit:/tomasulim/IRin 
WaveCollapseAll -1
